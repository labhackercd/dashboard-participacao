...
import EnquetesYearVotesAndSuggestion from '../../components/EnquetesYearVotesAndSuggestion'
...
class EnquetesPage extends Component {
    _isMounted = false;
                        ...
                        <ExpansionPanel defaultExpanded={false}>
                            ...
                            <ExpansionPanelDetails>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={12} md={12} zeroMinWidth>
                                        <Box>
                                            <EnquetesYearVotesAndSuggestion ano={this.state.ano} redraw={true}></EnquetesYearVotesAndSuggestion>
                                        </Box>

                                    </Grid>
                                    <Grid item xs={12} md={6} zeroMinWidth>
                                        <Box>
                                            <EnquetesTop5MostVoted ano={this.state.ano} redraw={true}></EnquetesTop5MostVoted>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={6} zeroMinWidth>
                                        <Box>
                                            <EnquetesTop3MostSuggestion ano={this.state.ano} redraw={true}></EnquetesTop3MostSuggestion>
                                        </Box>
                                    </Grid>
                                </Grid>
                            </ExpansionPanelDetails>
                        ...
                        <ExpansionPanel defaultExpanded={false}>
                            ...
                            <ExpansionPanelDetails>
                                <Grid container spacing={2}>
                                    <Grid item xs={12} md={12} zeroMinWidth>
                                        <FormControl variant="filled">
                                            <InputLabel htmlFor="filled-age-native-simple">Enquete</InputLabel>
                                            <Select
                                                native
                                    ...
                                    <Grid item xs={12} md={6} zeroMinWidth>
                                        <Box>
                                            <EnquetesSuggestionPoll enquete={this.state.enquete}></EnquetesSuggestionPoll>
                                        </Box>
                                    </Grid>
                                    <Grid item xs={12} md={6} zeroMinWidth>
                                        <Box>
                                            <EnquetesVotesPoll enquete={this.state.enquete} redraw></EnquetesVotesPoll>
                                        </Box>
                                    </Grid>
                                </Grid>
                            </ExpansionPanelDetails>
...
export default withStyles(useStyles)(EnquetesPage);